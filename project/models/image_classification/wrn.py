...
@utils.register_model(dataset='c', name='wrn28x10')
class WideResNet28x10(WideResNet):
    def __init__(self, num_classes=10):
        super(WideResNet28x10, self).__init__(num_classes=num_classes, depth=28, widen_factor=10, drop_rate=0.0)


@utils.register_model(dataset='c', name='wrn40x2')
class WideResNet40x2(WideResNet):
    def __init__(self, num_classes=10):
        super(WideResNet40x2, self).__init__(num_classes=num_classes, depth=40, widen_factor=2, drop_rate=0.0)


@utils.register_model(dataset='c', name='wrn40x4')
class WideResNet40x4(WideResNet):
    def __init__(self, num_classes=10):
        super(WideResNet40x4, self).__init__(num_classes=num_classes, depth=40, widen_factor=4, drop_rate=0.3)


if __name__ == '__main__':
    _model_classes = [WideResNet40x2, WideResNet40x4, WideResNet28x10]
